export const passwordGenerator = (options) => {
    ...
    const getCategoriesArray = () => {
        ...
        if (isLowerCaseRequired){
            availableCategories.push(lowercase); 
        }
        if(isUpperCaseRequired){
            availableCategories.push(uppercase)
        }
        if(isNumberRequired){
            availableCategories.push(numbers)
        }
        if(isSpecialSymbolRequired){
            availableCategories.push(specialCharacters)
        }
